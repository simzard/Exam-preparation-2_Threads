...
public class RandomUserForm extends javax.swing.JFrame implements Observer {
    ...
    public RandomUserForm() {
        initComponents();
        // add this object as an observer to the SUBJECT
        // (which is randomUserControl because it extends Observable)
  ...
  private void initComponents() {
    ...
    // this is the class whose responsibility is to carry out the heavy duty
    // it is a thread, so it will not block the UI
    private class WorkHorse implements Runnable {
  ...
  private void btn1Clicked(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn1Clicked
      // declare and start the thread to carry out the work
      Thread work = new Thread(new WorkHorse());
      work.start();
      
      // this will leave the UI in a NON-BLOCKED state! ;)
